...
const ModalCmp = forwardRef((props, ref) => {
    ...
    if (showModal) {
        return (<>
            ...
            <form name="downloadform" onSubmit={handleSubmit}>
                ...
                <div className="modal-body" style={{display: 'flex', flexDirection:'column'}}>
                    ...
                    <input type="email" placeholder="Email" style={{margin: '10px', width: '200px'}} required onChange={(e) => {
        ...
        return <button onClick={() => {
            setShowModal(true)
        }} className="btn btn-small info download-resume-btn"><i className="fa fa-download"></i>Resume</button>
    }
})
